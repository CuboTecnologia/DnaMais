...
{
    public class CategoriaProdutoFaixaFacade : BaseFacade, IDisposable
    {
        private CategoriaProdutoFaixaService serviceCategoriaProdutoFaixa;

        public CategoriaProdutoFaixaFacade(ModelStateDictionary modelState)
            : base(modelState)
        {
            serviceCategoriaProdutoFaixa = new CategoriaProdutoFaixaService();
        }

        public void Dispose()
        {
            serviceCategoriaProdutoFaixa.Dispose();
        }

        //#region Tipo de Contato

        public List<CategoriaProdutoFaixa> ListarTodasCategoriaFaixa()
        {
            return serviceCategoriaProdutoFaixa.ListarTodos().ToList();
        }

        public CategoriaProdutoFaixa ConsultarCategoriaFaixa(string id)
        {
            return serviceCategoriaProdutoFaixa.ConsultarPorId(id);
        }
